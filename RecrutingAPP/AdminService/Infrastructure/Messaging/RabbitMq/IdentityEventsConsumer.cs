...
{
    public class IdentityEventsConsumer : BackgroundService
    {
        private readonly IServiceScopeFactory _scopeFactory;
        private readonly IModel _channel;

        private const string Exchange = "identity.exchange";
        private const string Queue = "admin.identity.queue";

        public IdentityEventsConsumer(IServiceScopeFactory scopeFactory, IConfiguration configuration)
        {
