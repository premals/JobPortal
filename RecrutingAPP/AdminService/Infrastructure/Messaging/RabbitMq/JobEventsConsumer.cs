...
namespace AdminService.Infrastructure.Messaging.RabbitMq
{
    public class JobEventsConsumer : BackgroundService
    {
        ...
        private const string Exchange = "jobs.exchange";
        private const string Queue = "admin.jobs.queue";

        public JobEventsConsumer(IServiceScopeFactory scopeFactory, IConfiguration configuration)
        {
